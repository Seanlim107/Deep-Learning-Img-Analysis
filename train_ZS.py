...
def train(data_settings, model_settings, train_settings):
    ...
    if os.path.isfile(backbonefile):
        ...
        #Freeze weights of the backbone layer only, embedding layer is still training
        ...
        raise Exception('No backbone detected')
        # print('No Backbone detected')
